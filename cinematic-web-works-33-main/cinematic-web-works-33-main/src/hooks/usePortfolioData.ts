...
const defaultLongFormProjects: Project[] = [
  {
    id: "1",
    title: "Documentary: Rockefeller",
    description: "A deep dive into the creative minds of modern artists, showcasing complex narratives through intimate interviews and stunning visuals. This project involved extensive footage review, multi-track audio synchronization, and advanced color grading techniques to maintain viewer engagement throughout the 45-minute runtime.",
    category: "Documentary",
    tags: ["Documentary", "Color Grading", "Audio Sync", "Storytelling"],
    software: ["premiere", "aftereffects", "audition"],
    youtubeId: "https://www.youtube.com/watch?v=fNh_GyRbJDA",
...
const defaultShortFormProjects: Project[] = [
  {
    ...
    description: "A dynamic promotional video for the 0x100 tech campaign, optimized for social media engagement with bold visuals and compelling messaging.",
    category: "Social Media",
    tags: ["Social Media", "Tech", "Promotional"],
    software: ["premiere", "aftereffects"],
    youtubeId: "dQw4w9WgXcQ",
    clientName: "0x100 Tech",
    duration: "60s",
    year: "2024"
  },
  {
    id: "s2",
    title: "Sufox Brand Showcase",
